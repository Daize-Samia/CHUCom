<?php
  if(isset($_POST['submit'])){
    ...
    $insert_query = mysqli_query($conn, "INSERT INTO taches (idPerson,title, description, dateD, dateF, idepartement)VALUES (null,'{$_POST['title']}', '{$_POST['description']}', '{$_POST['dateD']}', '{$_POST['dateF']}', '{$idepartement}')");
...
<div class="accordion accordion-flush" id="accordionExample">
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingOne">
            <button class="accordion-button fw-bold text-dark collapsed " style="background: rgb(240,255,254); background: linear-gradient(122deg, rgba(240,255,254,1) 4%, rgba(45,253,247,1) 100%);" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
              Ajouter Une Tache
            </button>
          </h2>
                      ...
                      <div class="col-md-9">
                          <div class="p-3 py-2">
                            <form method="POST" action="Taches.php">
                              ...
                              <div class="mt-4 text-center"><input type="submit" name ="submit" class="btn btn-info profile-button" value="Ajouter"/></div>
                          </div>
                          <form>
                      </div>
                      </div>
